...
## Course Code: "ASTIS-CTBTBC" (CTBTB"C"→Certificate Award)
...
3. The last and fourth semester, concerning applying knowledge from the prior semesters, and attempting to **solve a problem faced by preferably your country or elsewhere**. (The code/idea developed is yours, and is not the property of [ASTIS](https://github.com/g0dEngineer/ASTIS/).) 

![Alt Text](https://github.com/g0dEngineer/ASTIS/blob/main/data/TypeA_NonProgrammers/data/time.png)

# Note: The total time required to complete this entire curriculum is roughly 4 weeks and 7 hours, excluding semester 4.
