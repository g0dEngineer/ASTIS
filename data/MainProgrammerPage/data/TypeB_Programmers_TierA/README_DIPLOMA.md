...
# [ASTIS](hhttps://github.com/g0dEngineer/ASTIS/) Curriculum Type B, Tier A (For programmers that know python, and know github)
## Course Code: "ASTIS-CTBTAD" (CTBTA"D"→Diploma Award)
...
3. The last and third semester, concerning applying knowledge from the prior semesters, and attempting to **solve a problem faced by preferably the Jamaican country or elsewhere**. (The code/idea developed is yours, and is not the property of [ASTIS](hhttps://github.com/g0dEngineer/ASTIS/).) 
...
3. For **this final semester** in particular, **you may or may not chose** to upload your code to github (while naming it as something like "My-Code_For-ASTIS-FinalSemester"):
      ...
      b. You could still choose to upload code to Github, prior to which you would have copyrighted it. In your portfolio, [ASTIS](hhttps://github.com/g0dEngineer/ASTIS/) will tell the public that it is copyrighted in this case. **(See portfolio section below.)**
